...
local service = 23095;  -- your service id, this is used to identify your service.

local secret = "2f8cd8e4-d6f9-4ff7-81c3-fb9b57f474ae";  -- make sure to obfuscate this if you want to ensure security.
...
--// Message callback (for Platoboost)
...
function loadMainGUI()
    ...
    local UsernameBox = MainTab:Input({
        Title = "Username",
    ...
    MainTab:Button({
        ...
        Desc = "Target fling",
        Callback = function()
            local target = UsernameBox.Value
